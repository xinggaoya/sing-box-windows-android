...
#### 应用内更新流程补全（下载通知安装）
- 修复设置页“检查更新”仅触发检查、未打通下载与安装链路的问题
- 新增设置页“应用更新”状态卡片，展示检查/发现更新/下载中/下载完成/失败状态
- 新增“下载更新包”与“安装已下载包”入口，形成完整用户闭环
- 下载完成后不再自动弹安装，改为发送系统通知，用户点击通知安装
- 增加下载进度通知与下载失败通知

### 文档

- 新增 `docs/IN_APP_UPDATE.md`，说明当前更新流程、状态机与关键代码位置
